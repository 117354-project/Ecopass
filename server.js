...
const IMAGE_SLOTS = new Set(['brand.logoImage', 'hero.image', 'hero.phoneImage', 'destinations.items.0.image', 'destinations.items.1.image', 'destinations.items.2.image', 'journey.image', 'cta.backgroundImage', 'cta.phoneImage']);
